-- Fix RLS Policies for vacation_splits and vacation_approvals (v2)
-- Removes invalid auth_is_admin() call.
...
-- C. VACATION PLANS
-- can_approve_vacation_plan already includes logic for super_admin/org_admin
...
USING (
  ...
  public.can_approve_vacation_plan(id, auth.uid())
);
