                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4 pt-2">
                            <a href="https://www.facebook.com/" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                                <Facebook className="h-5 w-5" />
                            </a>
                            <a href="https://twitter.com/" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                                <Twitter className="h-5 w-5" />
                            </a>
                            <a href="https://www.linkedin.com/in/mohamedarishi/" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                                <Linkedin className="h-5 w-5" />
                            </a>
                            <a href="https://www.instagram.com/" target="_blank" className="text-muted-foreground hover:text-primary transition-colors">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li className="pt-2">
                                <a href="mailto:konshedo@gmail.com" className="hover:text-primary transition-colors">konshedo@gmail.com</a>
                            </li>
                            <li>
                                <a href="tel:+966550555605" className="hover:text-primary transition-colors">+966 55 055 5605</a>
                            </li>
                        </ul>
                    </div>
                </div>
