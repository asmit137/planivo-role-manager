  ...
  public: {
    Tables: {
      ...
      subscription_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscription_overrides_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      user_groups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_groups_facility_id_fkey"
            columns: ["facility_id"]
            isOneToOne: false
            referencedRelation: "facilities"
            referencedColumns: ["id"]
      ...
      custom_role_module_access: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_role_module_access_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
            referencedRelation: "module_definitions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "custom_role_module_access_role_id_fkey"
            columns: ["role_id"]
            isOneToOne: false
