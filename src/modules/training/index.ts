...
export { default as TrainingHub } from '@/components/training/TrainingHub';
export { default as AttendanceEventSelector } from '@/components/training/AttendanceEventSelector';
export { default as TrainingEventForm } from '@/components/training/TrainingEventForm';
...
export { default as AttendanceReport } from '@/components/training/AttendanceReport';
